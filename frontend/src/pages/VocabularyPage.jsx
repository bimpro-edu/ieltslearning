...
const roadmap = [
  { title: 'Orientation', items: ['Why build vocabulary?', 'Band descriptors explained', 'Vocabulary learning strategies'] },
  { title: 'Core Vocabulary', items: ['Academic word list', 'Topic-based vocabulary', 'Collocations'] },
  { title: 'Advanced Vocabulary', items: ['Paraphrasing', 'Synonyms & antonyms', 'Idioms & phrases'] },
  { title: 'Practice & Assessment', items: ['Vocabulary quizzes', 'Band 5 → 9 comparisons', 'Evaluation checklists'] },
];
...
const VocabularyPage = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-2 py-8">
      <h1 className="text-3xl font-extrabold text-primary-700 mb-8 text-center">IELTS Vocabulary Course</h1>
