...
const roadmap = [
  { title: 'Orientation', items: ['Why grammar matters?', 'Band descriptors explained', 'Grammar learning strategies'] },
  { title: 'Core Grammar', items: ['Tenses', 'Sentence structure', 'Subject-verb agreement'] },
  { title: 'Advanced Grammar', items: ['Complex sentences', 'Conditionals', 'Inversion'] },
  { title: 'Practice & Assessment', items: ['Grammar quizzes', 'Band 5 → 9 comparisons', 'Evaluation checklists'] },
];
...
const GrammarPage = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-2 py-8">
      <h1 className="text-3xl font-extrabold text-primary-700 mb-8 text-center">IELTS Grammar Course</h1>
