...
const nodeDetails = {
  ...
  details: `The IELTS Listening test is a 30-minute exam with 40 questions, divided into 4 sections.\n\n**Sections:**\n1. Social conversation (Section 1): Two speakers discuss everyday topics, such as booking a hotel or making an appointment.\n2. Social monologue (Section 2): One speaker gives information, e.g., a tour guide describing a museum.\n3. Academic conversation (Section 3): Up to four speakers discuss academic topics, such as a group project or seminar.\n4. Academic monologue (Section 4): One speaker delivers a lecture on an academic subject.\n\n**Question Types:**\n- Multiple choice: Choose the correct answer from options.\n- Matching: Match items (names, features, etc.) to options.\n- Map/diagram/plan labeling: Fill in locations or features.\n- Form/note/table/flow-chart completion: Complete information from the audio.\n- Sentence completion: Fill in missing words.\n\n**Timing:**\n- 30 minutes for listening\n- 10 minutes to transfer answers (paper-based only)\n\n**Audio Features:**\n- Wide range of accents (British, Australian, American, Canadian, etc.)\n- Each recording played once only\n- Instructions and pauses provided\n\n**Scoring:**\n- Each correct answer = 1 mark\n- No penalty for wrong answers\n- Band score conversion chart used\n\n**Example:**\nYou may hear: "Now turn to Section 2. You will hear a monologue about a local museum..."\n\n**Tips:**\n- Skim all questions before the audio starts\n- Predict possible answers and their format\n- Underline keywords and look for synonyms\n- Listen for signpost words (first, next, finally)\n- Check word limits and spelling\n- Practice with official IELTS recordings`,
    icon: HeadphonesIcon,
    bg: '#b2ebf2',
  },
  criteria: {
    title: "Listening Criteria",
  details: `IELTS Listening is marked based on accuracy, following instructions, and understanding.\n\n**Key Criteria:**\n- Correct answers: Only exact answers are accepted.\n- Spelling: Misspelled answers are marked wrong.\n- Word limits: Exceeding the word limit results in no mark for that answer.\n- Instructions: Must follow all instructions (e.g., "NO MORE THAN TWO WORDS").\n- Main ideas and details: Ability to understand both general meaning and specific facts.\n\n**Band Descriptors:**\n- Band 9: Fully understands all information, no errors.\n- Band 7: Understands main ideas and most details, some errors.\n- Band 5: Understands basic information, frequent errors.\n\n**Example:**\nQ: Write NO MORE THAN TWO WORDS.\nA: "a beautiful garden" (WRONG, 3 words)\nA: "garden" (CORRECT)\n\n**Tips:**\n- Write answers in CAPITAL LETTERS for clarity\n- Always check spelling and grammar\n- Never leave blanks; guess if unsure\n- Transfer answers carefully\n- Review instructions before each section`,
    icon: LightbulbIcon,
    bg: '#fff9c4',
  },
  pitfalls: {
    title: "Common Pitfalls",
  details: `Many candidates lose marks due to avoidable mistakes.\n\n**Frequent Pitfalls:**\n- Losing focus after missing an answer\n- Spelling mistakes\n- Writing more than allowed words\n- Not predicting answers\n- Not checking transferred answers\n- Misunderstanding instructions\n- Not listening for paraphrases\n- Getting distracted by unfamiliar accents\n\n**Example:**\nQ: Write NO MORE THAN TWO WORDS.\nA: "a beautiful garden" (WRONG, 3 words)\nA: "garden" (CORRECT)\n\n**Tips to Avoid Pitfalls:**\n- If you miss an answer, move on quickly\n- Double-check word limits and spelling\n- Review instructions before each section\n- Practice with a variety of accents\n- Use prediction strategies\n- Transfer answers carefully\n- Review your error log after each test`,
    icon: WarningIcon,
    bg: '#ffe0b2',
  },
  tracker: {
    title: "Progress Tracker",
  details: `Tracking your progress helps you identify strengths and weaknesses.\n\n**How to Use:**\n- After each test, record your score (e.g., 28/40)\n- Use a band conversion chart to convert raw score to IELTS band\n- Log errors by type (spelling, not predicting, missing synonyms, accent confusion)\n- Track which sections and question types you struggle with\n- Note improvements over time\n\n**Example:**\nTest 1: 26/40 (Band 6.5), 4 spelling errors, 2 missed keywords\nTest 2: 30/40 (Band 7), 2 prediction errors, 1 accent confusion\nTest 3: 34/40 (Band 8), 0 spelling errors\n\n**Tips:**\n- Review your error log weekly to spot patterns\n- Focus practice on your weak areas\n- Set goals for each week (e.g., "Reduce spelling errors to 1")\n- Use charts and graphs to visualize progress\n- Celebrate improvements to stay motivated`,
    icon: LightbulbIcon,
    bg: '#b3e5fc',
  },
  activeListening: {
    ...
    <>
      ...
      {modal && (
        <div style={{ position: 'fixed', left: 0, bottom: 0, width: '100vw', height: 'auto', background: 'rgba(255,255,255,0.98)', zIndex: 2000, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', boxShadow: '0 -4px 32px #0003', padding: 0 }}>
          <div style={{ background: '#fff', borderRadius: 18, boxShadow: '0 8px 32px #0004', padding: 28, minWidth: '900px', maxWidth: '1400px', width: '80vw', height: 'auto', minHeight: 260, display: 'flex', flexDirection: 'row', alignItems: 'flex-start', gap: 32, position: 'relative', animation: 'fadeInUp .4s cubic-bezier(.4,0,.2,1)' }}>
            {/* Visual on the left */}
